...
function AboutFaq() {
  ...
  return (
    <section className="ww-wrap" style={{ paddingTop: 8, paddingBottom: 64 }}>
      <div className="ww-rule-ink" style={{ marginBottom: 40 }} />
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        <h2 style={{ fontSize: "clamp(24px,4vw,30px)", fontWeight: 700, letterSpacing: dir === "rtl" ? "0" : "-0.03em", lineHeight: 1.08 }}>{t.faq.heading}</h2>
        <p style={{ marginTop: 12, fontSize: 15, lineHeight: 1.7, color: "var(--g1)" }}>{t.faq.about}</p>
...
export default function BijliHisaab() {
  ...
  const NAV = ["calculator", "compare", "feedback"];
  ...
  return (
    <L.Provider value={{ lang, dir, t }}>
      <div className="ww-root" dir={dir} style={{ minHeight: "100vh" }}>
        ...
        {/* About & FAQ — shown on every page, after the main content */}
        <AboutFaq />
